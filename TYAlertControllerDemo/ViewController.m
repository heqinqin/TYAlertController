...
- (IBAction)showAlertViewAction:(id)sender {
    ...
    TYAlertView *alertView = [TYAlertView alertViewWithTitle:@"TYAlertView" message:nil];
...
- (IBAction)showAlertViewInWindowAction:(id)sender {
    ...
    TYAlertView *alertView = [TYAlertView alertViewWithTitle:nil message:@"有未保存的地址信息，确定要退出吗？"];
    alertView.messageLabel.textColor = [UIColor colorWithRed:34/255.0 green:34/255.0 blue:34/255.0 alpha:1];
    [alertView addAction:[TYAlertAction actionWithTitle:@"取消" style:TYAlertActionStyleCancel handler:^(TYAlertAction *action) {
